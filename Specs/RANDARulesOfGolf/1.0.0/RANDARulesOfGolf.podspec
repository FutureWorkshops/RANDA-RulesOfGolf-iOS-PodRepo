Pod::Spec.new do |s|
	...
	cs.dependency            'NotificationBannerSwift', :git => 'https://github.com/FWJonathan/NotificationBanner.git'
	cs.dependency		 'KalturaPlayerSDKStreamamg/Core', :git => 'git@github.com:StreamAMG/kaltura-ios-sdk.git', :branch => 'main'
